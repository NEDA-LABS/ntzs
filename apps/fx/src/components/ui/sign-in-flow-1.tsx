    ...
    >
      <div className="flex items-center justify-between w-full gap-x-6 sm:gap-x-8">
        ...
        <div className="hidden sm:flex items-center gap-2">
          ...
          <div className="relative group">
            <div className="absolute inset-0 -m-2 rounded-full hidden sm:block bg-emerald-500 opacity-20 filter blur-lg pointer-events-none transition-all duration-300 group-hover:opacity-40 group-hover:blur-xl" />
            <button className="relative z-10 px-4 py-2 text-xs font-semibold text-black bg-gradient-to-br from-emerald-300 to-emerald-500 rounded-full hover:from-emerald-200 hover:to-emerald-400 transition-all duration-200">
      ...
      >
        <div className="flex flex-col items-center space-y-3 w-full">
          ...
          <button className="w-full px-4 py-2 text-sm font-semibold text-black bg-gradient-to-br from-emerald-300 to-emerald-500 rounded-full">
            Become a Market Maker
          </button>
        </div>
      </div>
        ...
        <div className="flex flex-1 flex-col lg:flex-row">
          ...
          <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-20 pt-32 lg:pt-0">
            <div className="max-w-lg">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-emerald-500/30 bg-emerald-500/10 mb-6 fx-fade-up">
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
                <span className="text-emerald-400 text-xs font-medium">Base Mainnet — Live</span>
              </div>
              ...
              <div className="flex items-center gap-3 mb-10 fx-fade-up fx-delay-3">
                <a
                  href="#earn"
                  className="inline-flex items-center gap-2 px-5 py-2.5 text-sm font-medium text-black bg-gradient-to-br from-emerald-300 to-emerald-500 rounded-full hover:from-emerald-200 hover:to-emerald-400 transition-all duration-200"
                >
                  How It Works
                </a>
                <a
                ...
                {step === "email" ? (
                    ...
                    <form onSubmit={handleEmailSubmit} className="space-y-3">
                      <div className="relative">
                        <input
                          ...
                          className="w-full bg-white/5 backdrop-blur text-white border border-white/10 rounded-full py-3 px-5 focus:outline-none focus:border-emerald-500/50 placeholder:text-gray-600 text-sm"
                          required
                        />
                        <button
                          type="submit"
                          className="absolute right-1.5 top-1.5 text-black w-9 h-9 flex items-center justify-center rounded-full bg-gradient-to-br from-emerald-300 to-emerald-500 hover:from-emerald-200 hover:to-emerald-400 transition-colors group overflow-hidden"
                        >
                      ...
                      <button
                        type="submit"
                        className="w-full py-3 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 text-black font-semibold text-sm hover:from-emerald-300 hover:to-emerald-500 transition-all duration-200"
                      >
                        Provide Liquidity
                      </button>
                    </form>
                    ...
                    <div className="flex w-full gap-3">
                      ...
                      <motion.button
                        className={`flex-1 rounded-full font-semibold py-3 text-sm transition-all duration-300 ${
                          code.every((d) => d !== "")
                            ? "bg-gradient-to-br from-emerald-400 to-emerald-600 text-black hover:from-emerald-300 hover:to-emerald-500 cursor-pointer"
                  ...
                  >
                    <motion.div
                      ...
                      className="mx-auto w-16 h-16 rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center"
                    >
                      <svg
                    ...
                    <motion.a
                      ...
                      animate={{ opacity: 1 }}
                      transition={{ delay: 1 }}
                      className="block w-full rounded-full bg-gradient-to-br from-emerald-400 to-emerald-600 text-black font-semibold py-3 text-sm hover:from-emerald-300 hover:to-emerald-500 transition-all duration-200 text-center"
                    >
                      Open Dashboard
                    </motion.a>
                  </motion.div>
