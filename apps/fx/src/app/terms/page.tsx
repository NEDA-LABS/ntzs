  ...
  return (
    ...
    >
      ...
      <Section title="11. Privacy">
        <p>The Company collects and processes personal data in accordance with its Privacy Policy and the Personal Data Protection Act (2022) of Tanzania. Please review the <a href="/privacy" className="text-blue-400 hover:text-blue-300 underline">Privacy Policy</a> carefully before using the Platform.</p>
      </Section>
