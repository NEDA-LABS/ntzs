    ...
    >
      ...
      <Section title="Supported Assets">
        <table className="w-full text-xs border-collapse mt-2">
          ...
          <tbody className="divide-y divide-white/5">
            <tr><td className="py-2 pr-4 text-zinc-300 font-mono">nTZS</td><td className="py-2 pr-4 text-zinc-400">Tanzanian Shilling stablecoin</td><td className="py-2 text-zinc-400">Base, Ethereum, Polygon, Arbitrum</td></tr>
            <tr><td className="py-2 pr-4 text-zinc-300 font-mono">USDC</td><td className="py-2 pr-4 text-zinc-400">USD Coin (Circle)</td><td className="py-2 text-zinc-400">Base, Ethereum, Polygon, Arbitrum</td></tr>
            <tr><td className="py-2 pr-4 text-zinc-300 font-mono">USDT</td><td className="py-2 pr-4 text-zinc-400">Tether USD</td><td className="py-2 text-zinc-400">Ethereum, Polygon</td></tr>
            <tr><td className="py-2 pr-4 text-zinc-300 font-mono">EURC</td><td className="py-2 pr-4 text-zinc-400">Euro Coin (Circle)</td><td className="py-2 text-zinc-400">Base, Ethereum</td></tr>
          </tbody>
        </table>
      </Section>
      ...
      <Section title="FAQ">
        <div className="space-y-6">
          <FAQ q="Is there a minimum deposit?" a="Yes. The minimum initial nTZS deposit to activate an LP position is 10,000 nTZS." />
          <FAQ q="Can I withdraw my inventory at any time?" a="Yes. You may initiate a withdrawal at any time from the LP Dashboard. Withdrawals are processed on-chain and subject to standard network confirmation times (typically under 2 minutes on Base)." />
          <FAQ q="How are earnings paid out?" a="Earnings accrue directly to your LP Wallet in real time as orders fill. There is no lock-up period." />
          <FAQ q="What is the nTZS contract address?" a="0xF476BA983DE2F1AD532380630e2CF1D1b8b10688 on Base mainnet." />
        </div>
      </Section>

      <Section title="Support">
        <p>For technical support, account queries, or compliance matters:</p>
        <p>Email: support@nedapay.xyz<br />For urgent compliance matters: legal@nedapay.xyz</p>
      </Section>
    </LegalLayout>
  );
}
