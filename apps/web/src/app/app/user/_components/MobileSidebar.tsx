  ...
  return (
    <>
            ...
            {navItems.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  <item.icon className={`h-4 w-4 ${active ? 'text-blue-400' : 'text-zinc-500'}`} />
                  {item.label}
      ...
      <nav className="fixed bottom-0 inset-x-0 z-50 lg:hidden">
        <div className="absolute inset-0 bg-[#080810]/90 backdrop-blur-2xl border-t border-white/[0.07]" />
            ...
            return (
              ...
              >
                <span className={`relative flex h-[38px] w-[38px] items-center justify-center rounded-xl transition-all duration-200 ${
                  ...
                  {active && (
                    <span className="absolute -top-px left-1/2 h-[2px] w-5 -translate-x-1/2 rounded-full bg-blue-400 shadow-[0_0_6px_rgba(96,165,250,0.8)]" />
                  )}
