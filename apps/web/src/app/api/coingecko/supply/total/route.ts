...
/**
 * GET /api/coingecko/supply/total
 *
 * Public endpoint for CoinGecko to fetch the total supply of nTZS.
...
export async function GET() {
  ...
  try {
    ...
    console.error('[coingecko/supply/total]', err instanceof Error ? err.message : err)
