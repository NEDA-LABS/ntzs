 ...
 * because the withdraw form imports it to display live fee quotes.
 *
 ...
 * The fee is computed for the ROUTED provider at request-creation time and
 * stamped onto the record (burn_requests.psp_fee_tzs); executors read the
 * stamp, never recompute.
 */
